...
CREATE TABLE IF NOT EXISTS intake_events (
    ...
    amount REAL NOT NULL CHECK (amount > 0),
    unit TEXT NOT NULL,
    kj_snapshot REAL NOT NULL CHECK (kj_snapshot >= 0),
...
CREATE TABLE IF NOT EXISTS exercise_types (
    ...
    default_active_kj REAL CHECK (default_active_kj IS NULL OR default_active_kj >= 0),
...
CREATE TABLE IF NOT EXISTS exercise_events (
    ...
    active_kj REAL NOT NULL CHECK (active_kj >= 0),
    note TEXT,
    created_at TEXT NOT NULL,
    updated_at TEXT NOT NULL,
    active INTEGER NOT NULL DEFAULT 1 CHECK (active IN (0, 1))
...
CREATE TABLE IF NOT EXISTS calibration_runs (
    ...
    calibration_kj_day REAL NOT NULL,
    rmse REAL,
...
CREATE TABLE IF NOT EXISTS daily_metrics_cache (
    ...
    intake_kj REAL NOT NULL DEFAULT 0,
    baseline_kj REAL NOT NULL DEFAULT 0,
    exercise_kj REAL NOT NULL DEFAULT 0,
    total_burn_kj REAL NOT NULL DEFAULT 0,
    balance_kj REAL NOT NULL DEFAULT 0,
    predicted_close_kg REAL,
    calibration_kj REAL NOT NULL DEFAULT 0,
